...
public class HBaseUtil {
	...
	public static HBaseUtil defaultInstance() throws MasterNotRunningException,
	...
	public void put(String table, String rowKey, String family,
			String qualifier, byte[] data) throws IOException {
	...
	public byte[] get(String table, String rowKey, String family,
			String qualifier) throws IOException {
		HTable hTable = new HTable(this.config, Bytes.toBytes(table));
		Get g = new Get(Bytes.toBytes(rowKey));
		Result result = hTable.get(g);
		for (KeyValue rowKV : result.raw()) {
			if (family.equals(new String(rowKV.getFamily()))
					&& qualifier.equals(new String(rowKV.getQualifier()))) {
